...
def GetEnvironment():
  ...
  if not env['program'] in ['kaffpa', 'kaffpaE', 'partition_to_vertex_separator','improve_vertex_separator','library','graphchecker','label_propagation','node_separator','node_separator_ml']:
