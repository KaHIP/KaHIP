...
build_from_edge_list::build_from_edge_list() {
...
void build_from_edge_list::build_graph_from_edge_list( PPartitionConfig & config, parallel_graph_access & G, std::vector< source_target_pair > & edge_list) {
