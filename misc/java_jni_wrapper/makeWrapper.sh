...
export LIBDIRS="-L$KAHIP_HOME -L$OPENMPI_HOME/lib -L./"

set -x
javac KaHIPWrapper.java KaHIPWrapperResult.java
javah KaHIPWrapper
g++ $INCLUDEDIRS $LIBDIRS -fPIC -c KaHIPWrapper.cpp  
g++ $INCLUDEDIRS $LIBDIRS -fPIC -shared -o libwrapkahip.so -Wl,-soname,wrapkahip KaHIPWrapper.o -lkahip -lmpi -lmpi_cxx -lgomp
set +x
