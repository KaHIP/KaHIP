...
public:
        ...
        EdgeWeight perform_refinement_internal(const PartitionConfig & config, graph_access & G, std::vector< NodeID > & start_nodes, std::vector< bool > & moved_out_of_separator, bool balance = false, PartitionID to = 4);
...
#endif /* end of include guard: LOCALIZED_FM_NS_LOCAL_SEARCH_PY14MVLH */
